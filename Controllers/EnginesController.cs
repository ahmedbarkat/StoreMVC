...
namespace Safoa.Controllers
{
    ...
    public class EnginesController : BaseController
    {
        ...
        {
            return View(db.Engines.OrderByDescending(p => p.Date).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,EngineNum,CertificateNum,VoucherNum,Date,Name")] Engine engine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EngineNum,CertificateNum,VoucherNum,Date,Name")] Engine engine)
        {
            if (ModelState.IsValid)
            {
